...
| **12** | **Realizar Pedido**<br>*(Cliente)* | **Pantallas:** Carrito de Compras. | Julian | `---` | --- | --- | --- |
| | | **Lógica:** Importe total visible siempre, Tiempo estimado acumulado, Push Mozo (Espera Confirmación). | Julian | `---` | --- | --- | --- |
| | | **DB:** Insert tabla `pedidos` y tabla `detalle_pedido`. | Julian | `---` | --- | --- | --- |
| **13** | **Rechazo Pedido**<br>*(Mozo / Cliente)* | **Pantallas:** Carrito Editable (Cliente). | Julian | `---` | --- | --- | --- |
| | | **Lógica:** Mozo rechaza -> Push Cliente. Cliente edita/agrega/quita -> Push Mozo. | Julian| `---` | --- | --- | --- |
| | | **DB:** Update tabla `pedidos`. | Julian | `---` | --- | --- | --- |
| **14** | **Confirmar Pedido**<br>*(Mozo)* | **Pantallas:** Background Handler. | N/A | N/A | N/A | N/A | N/A |
| | | **Lógica:** División de comandas -> Push Sector Cocina y/o Bar. Habilita Hub de Juegos al cliente. | Julian | `---` | --- | --- | --- |
| | | **DB:** Update tabla `pedidos` (estado: en preparacion). | Julian | `---` | --- | --- | --- |
| **15** | **Sistema Juegos**<br>*(Cliente Reg)* | **Pantallas:** Hub 3 Juegos Funcionales. | Julian | `---` | --- | --- | --- |
...
| **21** | **Pedir Cuenta**<br>*(Cliente -> Mozo)* | **Pantallas:** Ticket Resumen (Items, Descuento, Total grande), Lector QR. | Carlos | `---` | --- | --- | --- |
| | | **Lógica:** Escaneo QR Propina (0-20%), Calculo Final. Push Notif pago a Mozo/Dueño/Super. | Carlos | `---` | --- | --- | --- |
| | | **DB:** Insert tabla `pagos`. | Carlos | `---` | --- | --- | --- |
| **22** | **Liberar Mesa**<br>*(Mozo)* | **Pantallas:** N/A. | N/A | N/A | N/A | N/A | --- |
| | | **Lógica:** Confirmación pago Mozo -> Push Dueño/Super. Habilitar visualización de gráficos desde QR Ingreso. | Carlos | `---` | --- | --- | --- |
| | | **DB:** Update tabla `mesas` (estado: libre). | Carlos | `---` | --- | --- | --- |
...
### Pre-entregas:
* **Primera fecha de pre-entrega:** 25-04-2026